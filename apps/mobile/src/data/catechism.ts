...
export const CATECHISM_PARTS: CatechismPart[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { label: { en: 'The Sacrament of Penance and Reconciliation', es: 'La Penitencia y la Reconciliación', la: 'Sacramentum Paenitentiae et Reconciliationis' }, from: 1422, to: 1498 },
  ...
  },
  {
    ...
    entries: [
      ...
      { label: { en: 'In the Fullness of Time', es: 'En la plenitud de los tiempos', la: 'In plenitudine temporum' }, from: 2598, to: 2622 },
      ...
      { label: { en: 'Guides for Prayer', es: 'Maestros de oración', la: 'Magistri orationis' }, from: 2683, to: 2696 },
      ...
      { label: { en: 'The Battle of Prayer', es: 'El combate de la oración', la: 'Certamen orationis' }, from: 2725, to: 2758 },
