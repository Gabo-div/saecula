...
export const CATECHISM_PARTS: CatechismPart[] = [
  {
    ...
    entries: [
      { label: { en: 'Man’s Capacity for God', es: 'El hombre es «capaz» de Dios', la: 'Homo est Dei « capax »' }, from: 27, to: 49 },
      { label: { en: 'God Comes to Meet Man', es: 'Dios al encuentro del hombre', la: 'Deus homini occurrit' }, header: true },
      { label: { en: 'The Revelation of God', es: 'La Revelación de Dios', la: 'De Revelatione Dei' }, from: 51, to: 73 },
      { label: { en: 'The Transmission of Divine Revelation', es: 'La transmisión de la Revelación divina', la: 'De transmissione Revelationis divinae' }, from: 74, to: 100 },
      { label: { en: 'Sacred Scripture', es: 'La Sagrada Escritura', la: 'De sacra Scriptura' }, from: 101, to: 141 },
      { label: { en: 'Man’s Response to God', es: 'La respuesta del hombre a Dios', la: 'Homo Deo respondet' }, header: true },
      ...
      { label: { en: 'I Believe in God, the Father Almighty, Creator', es: 'Creo en Dios, Padre todopoderoso, creador', la: '« Credo in Deum Patrem omnipotentem, Creatorem caeli et terrae »' }, from: 199, to: 421 },
      ...
      { label: { en: 'Conceived by the Holy Spirit, Born of the Virgin Mary', es: 'Concebido por el Espíritu Santo, nació de María Virgen', la: 'Iesus Christus « conceptus est de Spiritu Sancto, natus ex Maria Virgine »' }, from: 456, to: 570 },
      { label: { en: 'Suffered under Pontius Pilate, Was Crucified and Buried', es: 'Padeció bajo Poncio Pilato, fue crucificado y sepultado', la: 'Iesus Christus est « passus sub Pontio Pilato, crucifixus, mortuus et sepultus »' }, from: 571, to: 630 },
      { label: { en: 'He Descended into Hell, on the Third Day He Rose Again', es: 'Descendió a los infiernos, al tercer día resucitó', la: 'Iesus Christus « descendit ad inferos, tertia die resurrexit a mortuis »' }, from: 631, to: 658 },
      { label: { en: 'He Ascended into Heaven, Is Seated at the Right Hand of the Father', es: 'Subió a los cielos, está sentado a la derecha del Padre', la: 'Iesus « ascendit ad caelos, sedet ad dexteram Dei Patris omnipotentis »' }, from: 659, to: 667 },
      ...
      { label: { en: 'I Believe in the Holy Catholic Church', es: 'Creo en la Santa Iglesia Católica', la: '« Credo sanctam Ecclesiam Catholicam »' }, from: 748, to: 975 },
      { label: { en: 'I Believe in the Forgiveness of Sins', es: 'Creo en el perdón de los pecados', la: '« Credo remissionem peccatorum »' }, from: 976, to: 987 },
      { label: { en: 'I Believe in the Resurrection of the Body', es: 'Creo en la resurrección de la carne', la: '« Credo carnis resurrectionem »' }, from: 988, to: 1019 },
      { label: { en: 'I Believe in Life Everlasting', es: 'Creo en la vida eterna', la: '« Credo vitam aeternam »' }, from: 1020, to: 1065 },
    ],
  },
  {
    key: 'sacraments',
    ...
    entries: [
      { label: { en: 'The Paschal Mystery in the Age of the Church', es: 'El misterio pascual en el tiempo de la Iglesia', la: 'Mysterium paschale in Ecclesiae tempore' }, header: true },
      { label: { en: 'The Liturgy — Work of the Holy Trinity', es: 'La liturgia, obra de la Santísima Trinidad', la: 'Liturgia – Sanctissimae Trinitatis opus' }, from: 1077, to: 1112 },
      { label: { en: 'The Paschal Mystery in the Church’s Sacraments', es: 'El misterio pascual en los sacramentos de la Iglesia', la: 'Mysterium paschale in Ecclesiae sacramentis' }, from: 1113, to: 1134 },
      { label: { en: 'The Sacramental Celebration of the Paschal Mystery', es: 'La celebración sacramental del misterio pascual', la: 'Sacramentalis celebratio mysterii paschalis' }, header: true },
      { label: { en: 'Celebrating the Church’s Liturgy', es: 'Celebrar la Liturgia de la Iglesia', la: 'Ecclesiae liturgiam celebrare' }, from: 1136, to: 1199 },
      { label: { en: 'Liturgical Diversity and the Unity of the Mystery', es: 'Diversidad litúrgica y unidad del misterio', la: 'Diversitas liturgica et unitas mysterii' }, from: 1200, to: 1209 },
      { label: { en: 'The Sacraments of Christian Initiation', es: 'Los sacramentos de la iniciación cristiana', la: 'Initiationis christianae sacramenta' }, header: true },
      ...
      { label: { en: 'Other Liturgical Celebrations', es: 'Otras celebraciones litúrgicas', la: 'Ceterae liturgicae celebrationes' }, header: true },
  ...
  },
  {
    ...
    entries: [
      { label: { en: 'The Dignity of the Human Person', es: 'La dignidad de la persona humana', la: 'Personae humanae dignitas' }, header: true },
      { label: { en: 'Man: The Image of God', es: 'El hombre, imagen de Dios', la: 'Homo imago Dei' }, from: 1701, to: 1715 },
      { label: { en: 'Our Vocation to Beatitude', es: 'Nuestra vocación a la bienaventuranza', la: 'Nostra ad beatitudinem vocatio' }, from: 1716, to: 1729 },
      { label: { en: 'Man’s Freedom', es: 'La libertad del hombre', la: 'Hominis libertas' }, from: 1730, to: 1748 },
      { label: { en: 'The Morality of Human Acts', es: 'La moralidad de los actos humanos', la: 'Actuum humanorum moralitas' }, from: 1749, to: 1761 },
      { label: { en: 'The Morality of the Passions', es: 'La moralidad de las pasiones', la: 'Passionum moralitas' }, from: 1762, to: 1775 },
      ...
      { label: { en: 'Participation in Social Life', es: 'La participación en la vida social', la: 'In vita sociali participatio' }, from: 1897, to: 1927 },
      ...
      { label: { en: 'The Ten Commandments — «You Shall Love the Lord Your God»', es: 'Los Diez Mandamientos — «Amarás al Señor tu Dios»', la: '« Diliges Dominum Deum tuum in toto corde tuo et in tota anima tua et in tota mente tua »' }, header: true },
      ...
      { label: { en: '«You Shall Love Your Neighbor as Yourself»', es: '«Amarás a tu prójimo como a ti mismo»', la: '« Diliges proximum tuum tamquam teipsum »' }, header: true },
  ...
  },
  {
    ...
    entries: [
      { label: { en: 'The Revelation of Prayer', es: 'La revelación de la oración', la: 'Orationis revelatio' }, header: true },
      ...
      { label: { en: 'The Tradition of Prayer', es: 'La tradición de la oración', la: 'Orationis traditio' }, header: true },
      { label: { en: 'At the Wellsprings of Prayer', es: 'Fuentes de la oración', la: 'Ad orationis fontes' }, from: 2652, to: 2662 },
      { label: { en: 'The Way of Prayer', es: 'El camino de la oración', la: 'Orationis via' }, from: 2663, to: 2682 },
      { label: { en: 'Guides for Prayer', es: 'Maestros de oración', la: 'Duces ad orationem' }, from: 2683, to: 2696 },
      { label: { en: 'The Life of Prayer', es: 'La vida de oración', la: 'Orationis vita' }, header: true },
      ...
      { label: { en: '«The Summary of the Whole Gospel»', es: '«Resumen de todo el Evangelio»', la: '« Breviarium totius Evangelii »' }, from: 2761, to: 2776 },
