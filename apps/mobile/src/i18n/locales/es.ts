...
const es: typeof en = {
  ...
  streak: {
    ...
    notToday: 'Aún no hoy',
    daysThisYear_one: '{{count}} día este año',
    daysThisYear_other: '{{count}} días este año',
    weeks_one: '{{count}} semana seguida',
    weeks_other: '{{count}} semanas seguidas',
  ...
  apiKeys: {
    title: 'Claves de API',
    subtitle: 'Permite que un asistente de IA lea tu biblioteca de Saecula por MCP.',
    newKey: 'Nueva clave',
    namePlaceholder: 'Nombre (p. ej. portátil)',
    create: 'Crear',
    copyOnce: 'Cópiala ahora: esta clave no se vuelve a mostrar.',
    copy: 'Copiar',
    copied: 'Copiada',
    done: 'Listo',
    revokeConfirm: 'Todo lo que use esta clave deja de funcionar de inmediato.',
    revoke: 'Revocar',
    empty: 'Todavía no hay claves.',
    calls: 'llamadas',
    errors: 'errores',
    loadError: 'No se pudieron cargar tus claves',
    createError: 'No se pudo crear la clave',
    tooMany: 'Demasiadas claves activas. Revoca una primero.',
  ...
  bookmarks: {
    ...
    withNotes: 'Con notas',
    empty: 'Aún no hay versículos guardados. Mantén pulsado cualquier versículo en la Biblia para guardarlo.',
    ...
    notePlaceholder: 'Escribe tu nota personal…',
    ...
    shareVia: 'Compartido desde Saecula',
    saveError: 'No se pudo guardar el versículo',
    ...
    noteForSelectedPlaceholder: 'Escribe una nota para los versículos seleccionados…',
