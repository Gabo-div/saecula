...
En la era de la transformación digital de las humanidades, el estudio interconectado de las Sagradas Escrituras, la patrística, los concilios, los dogmas, los santos y los eventos históricos de la Iglesia Católica se ha convertido en un dominio de conocimiento profundamente entrelazado, donde cada entidad remite de manera directa o jerárquica a otras miles. Según estudios recientes sobre grafos de conocimiento (Hogan y otros, 2021), las redes de datos históricas poseen una topología compleja que demanda herramientas capaces de preservar las relaciones exactas entre sus nodos para sostener consultas de alta precisión. No obstante, la mayoría de los sistemas tradicionales de gestión documental y de las aplicaciones actuales de estudio teológico presentan limitaciones estructurales severas que impiden explotar dicha interconexión de manera fiable.

Una primera limitación radica en la incapacidad de las arquitecturas RAG tradicionales. Las arquitecturas habituales basadas en búsqueda por vectores destruyen la topología de los datos: al fragmentar los textos en bloques semánticos, un agente de inteligencia artificial pierde la capacidad de mapear relaciones directas o jerárquicas exactas, provocando alucinaciones cuando se realizan consultas de alta precisión histórica. Tal como señalan Gao y otros (2023), la recuperación vectorial mejora la fluidez de las respuestas, pero falla ante el razonamiento de múltiples saltos sobre datos estructurados, un requisito ineludible en dominios donde la exactitud de las referencias no admite margen de error.

Una segunda limitación es la ineficiencia de las bases de datos relacionales puras. Representar redes de conocimiento profundamente interconectadas mediante consultas SQL tradicionales requiere múltiples operaciones de cruce de datos recursivos, lo que genera un costo de procesamiento exponencial y degrada el tiempo de respuesta. En contraste, los motores de grafos como Neo4j ejecutan estas travesías recursivas con complejidad reducida al recorrer las aristas directamente (Needham y Hodler, 2018), lo que evidencia que una arquitectura uniforme relacional resulta insuficiente para el dominio teológico-histórico.

Una tercera limitación concierne a la complejidad del manejo multilingüe y de las variantes de traducción. Almacenar una misma entidad conceptual en diferentes idiomas, como español, inglés, latín o griego, y con múltiples ediciones o traducciones bíblicas históricas, suele provocar duplicación masiva de datos y pérdida de integridad en los enlaces de referencias cruzadas. En el contexto latinoamericano, y particularmente en Venezuela, la comunidad de investigadores, estudiantes y profesionales de la teología enfrenta además la carencia de plataformas accesibles que permitan correlacionar fuentes primarias y secundarias con trazabilidad histórica, lo que frena la producción académica de alto nivel y la preservación digital del patrimonio documental católico.
...
La presente investigación se justifica por la necesidad de dotar al estudio de la historia y la teología católica de una herramienta de alta precisión que preserve la topología exacta del conocimiento, ante la incertidumbre generada por las respuestas erróneas que producen los sistemas de inteligencia artificial basados únicamente en recuperación vectorial, cuyas limitaciones frente al razonamiento de múltiples saltos sobre datos estructurados han sido documentadas (Gao y otros, 2023).
